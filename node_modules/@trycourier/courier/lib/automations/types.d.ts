export declare type AutomationStepAction = "cancel" | "delay" | "send" | "send-list";
...
export declare type AutomationStep = IAutomationCancelStep | IAutomationDelayStep | IAutomationSendStep | IAutomationSendListStep;
